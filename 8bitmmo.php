...
return _z},set:function(val){_z=val}})});</script> </head> <style>.img2{width:100%;height:auto;aspect-ratio:attr(width) / attr(height)}</style> <body>  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top shadow-sm" id="mainNav"> <div class="container"> <a href="index.php" class="navbar-brand mt-n2 mb-n2"><img src="assets/images/freetogame-logo.png" height="45" alt="FreeToGame"></a> <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button> <div class="collapse navbar-collapse" id="navbarResponsive"> <ul class="navbar-nav mr-auto"> <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="games.php" id="dropdown02" data-toggle="dropdown" aria-expanded="false">Free Games</a> <ul class="dropdown-menu" aria-labelledby="dropdown02"> <li><a class="dropdown-item" href="games/mmorpg.php">MMORPG</a></li> <li><a class="dropdown-item" href="games/shooter.php">Shooter</a></li> <li><a class="dropdown-item" href="games/moba.php">MOBA</a></li> <li><a class="dropdown-item" href="games/anime.php">Anime</a></li> <li><a class="dropdown-item" href="games/battle-royale.php">Battle Royale</a></li> <li><a class="dropdown-item" href="games/strategy.php">Strategy</a></li> <li><a class="dropdown-item" href="games/fantasy.php">Fantasy</a></li> <li><a class="dropdown-item" href="games/sci-fi.php">Sci-Fi</a></li> <li><a class="dropdown-item" href="games/card.php">Card Games</a></li> <li><a class="dropdown-item" href="games/racing.php">Racing</a></li> <li><a class="dropdown-item" href="games/fighting.php">Fighting</a></li> <li><a class="dropdown-item" href="games/social.php">Social</a></li> <li><a class="dropdown-item" href="games/sports.php">Sports</a></li> <div class="dropdown-divider"></div> <a class="dropdown-item a2" href="games.php">Free-To-Play Games</a> </ul> </li> <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="browser.php" id="dropdown03" data-toggle="dropdown" aria-expanded="false">Browser Games</a> <ul class="dropdown-menu" aria-labelledby="dropdown03"> <li><a class="dropdown-item" href="browser/mmorpg.php">Browser MMORPG</a></li> <li><a class="dropdown-item" href="browser/shooter.php">Browser Shooter</a></li> <li><a class="dropdown-item" href="browser/anime.php">Browser Anime</a></li> <li><a class="dropdown-item" href="browser/strategy.php">Browser Strategy</a></li> <li><a class="dropdown-item" href="browser/fantasy.php">Browser Fantasy</a></li> <li><a class="dropdown-item" href="browser/sci-fi.php">Browser Sci-Fi</a></li> <li><a class="dropdown-item" href="browser/racing.php">Browser Racing</a></li> <li><a class="dropdown-item" href="browser/social.php">Browser Social</a></li> <li><a class="dropdown-item" href="browser/sports.php">Browser Sports</a></li> <div class="dropdown-divider"></div> <a class="dropdown-item a2" href="browser.php">Browser Games</a> </ul> </li> <li class="nav-item"> <a class="nav-link js-scroll-trigger" href="giveaways.php">Special Offers</a> </li> <li class="nav-item"> <a class="nav-link js-scroll-trigger" href="api-doc.php">API</a> </li> <li class="nav-item dropdown"> <a class="nav-link" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fas fa-ellipsis-h"></i> </a> <div class="dropdown-menu shadow" aria-labelledby="navbarDropdown"> <h6 class="dropdown-header">GAMEVAULT</h6> </div> </li> </ul> <ul class="navbar-nav ml-auto mr-4"> <li class="nav-item"> <a class="nav-link js-scroll-trigger" data-toggle="tooltip" data-placement="bottom" title="Search Games" href="search.php"><i class="fas fa-search"></i><span class="ml-1 d-lg-none"> Search</span></a> </li> 
 ...
 <nav class="navbar">
	...
	<main> <div class="container py-4 video-page"> <div class="gameprofile_background" style="background-image: url(g/181/background.webp);"> <div class="gameprofile_gradient"></div> </div> <div class="row">  <div class="col-md-4"> <div class="sidebar control-box"> <div class="card shadow mb-3 rounded"> <img class="img2 card-img-top progressive replace" width="331" height="201" src="g/181/thumbnail.jpg" alt="8BitMMO"> <video class="featuredvideo" loop preload="none" muted><source src="g/181/videoplayback.webm" type="video/webm"></source></video> </div> <div class="row"> <div class="col-3 col-lg-2 mr-2"> <span class="btn btn-dark2 mb-3">FREE</span> </div> <div class="col"> <a type="button" name="playnow" class="btn btn-ftg-blue btn-block" href="https://8bitmmo.net/" rel="nofollow" target="_blank"><strong>PLAY NOW </strong><i class="fas fa-sign-out-alt"></i></a> </div> </div> <div class="rate-section btn-group btn-block mb-3 text-center shadow-sm rounded"> 
...
<input type="hidden" id="gameId" value="1"> <!-- Replace 1 with the actual game ID -->
...
<script>
    ...
    window.addEventListener('load', loadCounts);
         ...
         <div class="dropdown-menu shadow" aria-labelledby="btnGroupDrop1" x-placement="bottom-start"> <a class="dropdown-item" onclick="notSignedIn()"><i class="fas fa-gamepad pr-1"></i> Currently Playing</a> <a class="dropdown-item" onclick="notSignedIn()"><i class="fas fa-check pr-1"></i> Played</a> <a class="dropdown-item" onclick="notSignedIn()"><i class="fas fa-trophy pr-1"></i> Completed</a> <a class="dropdown-item" onclick="notSignedIn()"><i class="far fa-clock pr-1"></i> Play Later</a> </div> </div>  <ul class="list-group mt-3 order-10 border-left-primary"> <div class="list-group-item"> <div class="row"> <div class="col">downloadStandaloneWindows.php<br> <span class="text-muted"> 151 MB<i class="fab fa-windows ml-3"></i></span> </div> <div class="col text-center"><a class="btn btn-grey" role="button" href="#" data-toggle="modal" data-target="#downloadModal"> Download</a></div> </div> </div> <li class="list-group-item d-flex justify-content-between align-items-center text-muted"> <small>Direct download Available</small><i class="fas fa-download mr-1"></i> </li> </ul> <script>var download_link='http://8bitmmo.net/downloadStandaloneWindows.php';function Link(){document.getElementById('Link').href=download_link}</script>

      <span class="small text-muted ml-1"><i class="fas fa-user mr-2"></i>Requires 3rd-Party Account</span> </div> </div>   <div class="col-md-8">  <nav aria-label="breadcrumb"> <ul class="breadcrumb2 small mb-0"> <li class="breadcrumb-item2"><a class="nocolor" href="index.php">Home</a></li> <li class="breadcrumb-item2"><a class="nocolor" href="games.php">Free Games</a></li> <li class="breadcrumb-item2 text-muted" aria-current="page">8BitMMO</li> </ul> </nav> <style>.breadcrumb2{list-style:none;padding:0}.breadcrumb-item2{display:inline-block}.breadcrumb-item2::after{content:">";margin-left:2px}.breadcrumb-item2:last-child::after{content:""}</style> <h1>8BitMMO</h1>  <div class="row py-3"> <div class="col-md-7"> <div class="statRightHolder mb-2"> <ul class="statsLeft2"> <h4> <span class="blue"><i class="fas fa-star mr-2"></i></span><span>Massively Positive</span> </h4> <li> <span class="mr-2">2</span><span>Member Ratings</span> </li> </ul> <ul class="statsLeft2"> <li> <span class="yellow"><i class="far fa-user mr-2"></i> 54</span> Members have this game in their library!</li> </ul> <ul class="statsLeft"> <li> <span class="red"><i class="far fa-comment-alt mr-2"></i> 0</span> Reviews</li> </ul> <ul class="statsRight"> <li> <span><i class="fas fa-long-arrow-alt-down"></i> 35%</span><span class="ml-1">Popularity</span> </li> </ul> </div> </div>  <div class="col"> <div class="d-flex justify-content-center align-middle"> <div class="progress-pie-chart" data-percent="100">  <div class="ppc-progress"> <div class="ppc-progress-fill"></div> </div> <div class="ppc-percents"> <div class="pcc-percents-wrapper"> <span class="small">%</span> </div> </div> </div> </div> </div> </div>   <div id="submitReview" class="anchor mt-3"> <span class="float-right"><div class="rating"> <h2 class="d-flex flex-row mr-2 h4">Feel free to share your reviews! </h2> </div></span> <h2 class="d-flex flex-row mr-2 h4">What do you think about 8BitMMO? </h2>
...
<input type="hidden" id="gameId" value="3"> <!-- Replace 1 with the actual game ID -->
...
<script>
    ...
    window.addEventListener('load', loadUserThoughts);
      ...
      <h2 class="mt-4 h3">About 8BitMMO</h2> <hr class="mt-2 mb-3"> <div id="summary"> <p class="collapse text-justify" id="collapseSummary"> Listen up all of you 8­bit lovers out there! As the name would suggest, 8BitMMO is a free to play retro­style 2D massively multiplayer game! Basically, it’s a giant sandbox. You can build anything your heart desires; be the king of your own castle, or live simply in a quaint little home; and if you choose to build your own city, 8BitMMO has an impressive array of management tools to help you oversee it all! The best part about this persistent streaming world is that it’s free to play!<br> <br> You and your friends will love the interactivity of 8BitMMO, as you are able to customize your character to fit your own style. Choose from hats, clothing and accessories ­ and even change the color of your skin! If you’re more into action, 8BitMMO has that too! Do you hate the thought of Lobbyist Slugs, Lawyer Cats and Hipsters? Invite your friends and fight off these nefarious enemies together! If you’re looking for something a little bit different, why not become a zombie? In 8BitMMO even that is possible! Just make sure you have a steady supply of brains (yum!) to keep you well fed (and don’t worry about your victims, they’ll just become zombies too!).<br> <br> 8BitMMO is a world built 100% by the people who play it, and the world is massive so you don’t have to worry about running out of room. The game’s MegaMap is based on the Google Maps API and is a handy way to browse the world and share your creations with your friends. Unlike many other games out there, 8BitMMO is under interactive development, which means development of the game is still ongoing, and you have the opportunity to suggest your ideas or vote on others that you like! What will you build? </p> <a class="collapsed" data-toggle="collapse" href="#collapseSummary" aria-expanded="false" aria-controls="collapseSummary"></a> </div> <hr> <div class="text-muted disclosure"> <p>Disclosure: FreeToGame works closely with publishers and developers to offer a free and rewarding experience. In order to keep everything free to use we may sometimes earn a small commission from some partners. Find more info in our <a href="faq.php">FAQ</a> page. </p> <p> </p> </div>  <h2 class="mt-5 h3">Additional Information</h2> <div class="text-muted mt-n2"> <i class="fas fa-info-circle mr-2"></i>Please note this free-to-play game may or may not offer optional in-game purchases.</div> <hr class="mt-2 mb-3"> <div class="row mb-3"> <div class="col-6 col-md-4"> <span class="text-muted">Title<br></span> <p>8BitMMO</p> </div> <div class="col-6 col-md-4"> <span class="text-muted">Developer<br></span> Archive Entertainment </div> <div class="col-6 col-md-4"> <span class="text-muted">Publisher<br></span> Archive Entertainment </div> <div class="col-6 col-md-4"> <span class="text-muted">Release Date<br></span> January 26, 2015 </div> <div class="col-6 col-md-4"> <span class="text-muted">Genre<br></span> MMORPG </div> <div class="col-6 col-md-4"> <span class="text-muted">Platform<br></span> Windows, Browser </div> </div>  <h2 class="h3 font-weight-dark text-center text-lg-left mt-5 mb-0">8BitMMO Screenshots</h2> <hr class="mt-2 mb-3"> <div class="row text-center text-lg-left"> <div class="col-lg-3 col-md-4 col-6"> <a href="g/181/8BitMMO-1.jpg" data-lity class="d-block mb-3 h-100" alt="8BitMMO Gameplay Screenshot 1"> <img class="thumb-gallery shadow-sm rounded" src="g/181/8BitMMO-1-small.jpg" alt="8BitMMO Thumbnail 1"> </a> </div> <div class="col-lg-3 col-md-4 col-6"> <a href="g/181/8BitMMO-2.jpg" data-lity class="d-block mb-3 h-100" alt="8BitMMO Gameplay Screenshot 2"> <img class="thumb-gallery shadow-sm rounded" src="g/181/8BitMMO-2-small.jpg" alt="8BitMMO Thumbnail 2"> </a> </div> <div class="col-lg-3 col-md-4 col-6"> <a href="g/181/8BitMMO-3.jpg" data-lity class="d-block mb-3 h-100" alt="8BitMMO Gameplay Screenshot 3"> <img class="thumb-gallery shadow-sm rounded" src="g/181/8BitMMO-3-small.jpg" alt="8BitMMO Thumbnail 3"> </a> </div> <div class="col-lg-3 col-md-4 col-6"> <a href="g/181/8BitMMO-4-small.jpg" data-lity class="d-block mb-3 h-100" alt="8BitMMO Gameplay Screenshot 4"> <img class="thumb-gallery shadow-sm rounded" src="g/181/8BitMMO-4.jpg" alt="8BitMMO Thumbnail 4"> </a> </div> </div>  <h2 class="h3 font-weight-dark text-center text-lg-left mt-5 mb-0">Minimum System Requirements <span class="small text-muted">(Windows)</span> </h2> <hr class="mt-2 mb-3"> <div class="row"> <div class="col-sm-6"> <span class="text-muted">OS<br></span> <p>Windows XP </p> <span class="text-muted">Memory<br></span> <p>2 GB RAM </p> <span class="text-muted">Storage<br></span> <p>200 MB available space </p> </div> <div class="col-sm-6"> <span class="text-muted">Processor<br></span> <p>?</p> <span class="text-muted">Graphics<br></span> <p>Integrated graphics is fine</p> <span class="text-muted">Additional Notes<br></span> <p>Specifications may change during development</p> </div> </div> <h2 class="font-weight-dark h3 text-center text-lg-left mt-5 mb-0">Minimum System Requirements <span class="small text-muted">(Browser)</span> </h2> <hr class="mt-2 mb-3"> <span class="text-muted text"><p>8BitMMO is a browser based game and should run smoothly on practically any PC with a updated web-browser.</p> <p>If you have old hardware or software, you may still be able to play 8BitMMO, but your game experience may suffer. For the best gameplay experience, we recommend the latest versions of Firefox, Chrome, or Internet Explorer.</p> </span>  <hr> <div class="text-muted small">All material on this page is copyrighted by ©Archive Entertainment and their respective licensors. All other trademarks are the property of their respective owners.</div>  

     <hr class="mt-2 mb-3"> <div class="reviews"> </div> 
      <div class="row mt-2 align-items-center mb-5"> <div class="col text-muted justify-content-center">Play this game and post your review! </div> <div class="col-6"> <a class="btn btn-primary float-right" href="#submitReview" role="button">Submit Review</a> </div> </div> 

       <a href="like/8bitmmo.php" class="btn btn-outline-secondary btn-sm float-right">See All<i class="ml-1 fas fa-chevron-right"></i></a> <h2 class="h3">Games like 8BitMMO</h2> <hr class="mt-2 mb-3"> <div class="row text-center text-lg-left"> <div class="game-card col-md-4 col-md-4 mb-4 video-card" data-video-src="/g/256/videoplayback.webm"> <div class="card grow shadow"> <div class="image-wrappers"> <img class="img2 card-img-top" width="262" height="148" src="g/256/thumbnail.jpg" alt="Realm of the Mad God - A fast paced 2d free to play MMO shooter game with a retro 8-bit style."> <div class="loader-wrapper"> <div class="spinner-grow ftg-blue" role="status"> <span class="sr-only">Loading...</span> </div> </div> </div> <video class="featuredvideo3widget" loop preload="none" muted></video> <div class="card-body"> <span class="badge badge-ftg py-1 px-1 mt-1 float-right">FREE</span> <a href="realm-mad-god.php" class="stretched-link no-underline"><h4 class="card-title text-truncate mb-n1">Realm of the Mad God</h4></a> </div> </div> </div> <div class="game-card col-md-4 col-md-4 mb-4 video-card" data-video-src="/g/380/videoplayback.webm"> <div class="card grow shadow"> <div class="image-wrappers"> <img class="img2 card-img-top" width="262" height="148" src="g/380/thumbnail.jpg" alt="Dark Orbit Reloaded - A browser-based 3D space-combat MMO with a massive playerbase!"> <div class="loader-wrapper"> <div class="spinner-grow ftg-blue" role="status"> <span class="sr-only">Loading...</span> </div> </div> </div> <video class="featuredvideo3widget" loop preload="none" muted></video> <div class="card-body"> <span class="badge badge-ftg py-1 px-1 mt-1 float-right">FREE</span> <a href="darkorbit.php" class="stretched-link no-underline"><h4 class="card-title text-truncate mb-n1">Dark Orbit Reloaded</h4></a> </div> </div> </div> <div class="game-card col-md-4 col-md-4 mb-4 video-card" data-video-src="/g/426/videoplayback.webm"> <div class="card grow shadow"> <div class="image-wrappers"> <img class="img2 card-img-top" width="262" height="148" src="g/426/thumbnail.jpg" alt="AdventureQuest Worlds - A free-to-play 2D fantasy browser MMORPG. There are no downloads or software to install! "> <div class="loader-wrapper"> <div class="spinner-grow ftg-blue" role="status"> <span class="sr-only">Loading...</span> </div> </div> </div> <video class="featuredvideo3widget" loop preload="none" muted></video> <div class="card-body"> <span class="badge badge-ftg py-1 px-1 mt-1 float-right">FREE</span> <a href="adventurequest-worlds.php" class="stretched-link no-underline"><h4 class="card-title text-truncate mb-n1">AdventureQuest Worlds</h4></a> </div> </div> </div> </div>  <div class="modal fade" id="downloadModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true"> <div class="modal-dialog modal-dialog-centered" role="document"> <div class="modal-content"> <div class="modal-header"> <h5 class="modal-title" id="exampleModalLongTitle">Download 8BitMMO</h5> <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button> </div> <div class="modal-body"> <p>Please note that to play 8BitMMO a 3rd-Party account from Archive Entertainment is required. Click the button bellow to create your account.</p> <hr> <span class="text-center"><p><i class="fas fa-file-download"></i> File: downloadStandaloneWindows.php <span class="text-muted">(151 MB)</span></p></span> </div> <div class="text-center mb-4"> <a type="button" class="btn btn-grey" href="https://8bitmmo.net/" rel="nofollow" target="_blank"><i class="fas fa-user-plus"></i> 8BitMMO Account</a> <a class="btn btn-grey" href="#download_link" rel="nofollow" role="button" id="Link" onclick="Link()"><i class="fas fa-download"></i> Start Download</a> </div> </div> </div> </div> </div> </div> </div> </div> </main> </body> 
<!-- Mirrored from www.freetogame.com/8bitmmo by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Mar 2024 08:08:13 GMT -->
