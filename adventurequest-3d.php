...
</div>  <main> <div class="container py-4 video-page"> <div class="gameprofile_background" style="background-image: url(g/89/background.webp);"> <div class="gameprofile_gradient"></div> </div> <div class="row">  <div class="col-md-4"> <div class="sidebar control-box"> <div class="card shadow mb-3 rounded"> <img class="img2 card-img-top progressive replace" width="331" height="201" src="g/89/thumbnail.jpg" alt="AdventureQuest 3D"> <video class="featuredvideo" loop preload="none" muted><source src="g/89/videoplayback.webm" type="video/webm"></source></video> </div> <div class="row"> <div class="col-3 col-lg-2 mr-2"> <span class="btn btn-dark2 mb-3">FREE</span> </div> <div class="col"> <a type="button" name="playnow" class="btn btn-ftg-blue btn-block" href="https://www.aq3d.com/" rel="nofollow" target="_blank"><strong>PLAY NOW </strong><i class="fas fa-sign-out-alt"></i></a> </div> </div>  <div class="rate-section btn-group btn-block mb-3 text-center shadow-sm rounded"> 
...
<input type="hidden" id="gameId" value="8"> <!-- Replace 1 with the actual game ID -->
...
<script>
    ...
    <div class="dropdown-menu shadow" aria-labelledby="btnGroupDrop1" x-placement="bottom-start"> <a class="dropdown-item" onclick="notSignedIn()"><i class="fas fa-gamepad pr-1"></i> Currently Playing</a> <a class="dropdown-item" onclick="notSignedIn()"><i class="fas fa-check pr-1"></i> Played</a> <a class="dropdown-item" onclick="notSignedIn()"><i class="fas fa-trophy pr-1"></i> Completed</a> <a class="dropdown-item" onclick="notSignedIn()"><i class="far fa-clock pr-1"></i> Play Later</a> </div> </div>  <span class="small text-muted ml-1"><i class="fas fa-user mr-2"></i>Requires 3rd-Party Account</span> </div> </div>   <div class="col-md-8">  <nav aria-label="breadcrumb"> <ul class="breadcrumb2 small mb-0"> <li class="breadcrumb-item2"><a class="nocolor" href="index.php">Home</a></li> <li class="breadcrumb-item2"><a class="nocolor" href="games.php">Free Games</a></li> <li class="breadcrumb-item2 text-muted" aria-current="page">AdventureQuest 3D</li> </ul> </nav> <style>.breadcrumb2{list-style:none;padding:0}.breadcrumb-item2{display:inline-block}.breadcrumb-item2::after{content:">";margin-left:2px}.breadcrumb-item2:last-child::after{content:""}</style> <h1>AdventureQuest 3D</h1>  <div class="row py-3"> <div class="col-md-7"> <div class="statRightHolder mb-2"> <ul class="statsLeft2"> <h4> <span class="blue"><i class="fas fa-star mr-2"></i></span><span>Massively Positive</span> </h4> <li> <span class="mr-2">3</span><span>Member Ratings</span> </li> </ul> <ul class="statsLeft2"> <li> <span class="yellow"><i class="far fa-user mr-2"></i> 56</span> Members have this game in their library!</li> </ul> <ul class="statsLeft"> <li> <span class="red"><i class="far fa-comment-alt mr-2"></i> 0</span> Reviews</li> </ul> <ul class="statsRight"> <li> <span><i class="fas fa-long-arrow-alt-down"></i> 9%</span><span class="ml-1">Popularity</span> </li> </ul> </div> </div>  <div class="col"> <div class="d-flex justify-content-center align-middle"> <div class="progress-pie-chart" data-percent="100">  <div class="ppc-progress"> <div class="ppc-progress-fill"></div> </div> <div class="ppc-percents"> <div class="pcc-percents-wrapper"> <span class="small">%</span> </div> </div> </div> </div> </div> </div>   <div id="submitReview" class="anchor mt-3"> <span class="float-right"><div class="rating"> <h2 class="d-flex flex-row mr-2 h4">Feel free to share your reviews! </h2> </div></span> <h2 class="d-flex flex-row mr-2 h4">What do you think about AdventureQuest 3D? </h2> 
...
<script>
    ...
    window.addEventListener('load', loadUserThoughts);
     ...
     <h2 class="mt-4 h3">About AdventureQuest 3D</h2> <hr class="mt-2 mb-3"> <div id="summary"> <p class="collapse text-justify" id="collapseSummary"> AdventureQuest 3D (AQ3D) is a free to play cross-platform fantasy MMORPG with colorful cartoony graphics from the creators of the original 2D RPG Flash game! AdventureQuest was created by the game’s original designers and is scheduled to come out in 4th Quarter 2016.<br> <br> Journey through a colorful persistent world filled with magic, monsters, vampires, werewolves, pirates, ninjas, dragons and more with graphics that will appeal to kids and adults. Unlike traditional MMORPGs, which limit players to a single class, AdventureQuest 3D allows players to switch between any of the game’s classes upon unlocking them. So don’t forget to visit the Hall of Trainers where you can unlock new classes.<br> <br> Play with people around the world in co-op, solo mode or PVP. You can even play with friends who are not at your level, the “side-kicking” feature will boost your friend’s level so they can play with you in dangerous places. AdventureQuest 3D was developed by Artix Entertainment, the creators of AdventureQuest, DragonFable, MechQuest, and AQWorlds. You can access the world of AQ3D from your phone, tablet, and PC. </p> <a class="collapsed" data-toggle="collapse" href="#collapseSummary" aria-expanded="false" aria-controls="collapseSummary"></a> </div> <hr> <div class="text-muted disclosure"> <p>Disclosure: FreeToGame works closely with publishers and developers to offer a free and rewarding experience. In order to keep everything free to use we may sometimes earn a small commission from some partners. Find more info in our <a href="faq.php">FAQ</a> page. </p> <p> </p> </div>  <h2 class="mt-5 h3">Additional Information</h2> <div class="text-muted mt-n2"> <i class="fas fa-info-circle mr-2"></i>Please note this free-to-play game may or may not offer optional in-game purchases.</div> <hr class="mt-2 mb-3"> <div class="row mb-3"> <div class="col-6 col-md-4"> <span class="text-muted">Title<br></span> <p>AdventureQuest 3D</p> </div> <div class="col-6 col-md-4"> <span class="text-muted">Developer<br></span> Artix Entertainment </div> <div class="col-6 col-md-4"> <span class="text-muted">Publisher<br></span> Artix Entertainment </div> <div class="col-6 col-md-4"> <span class="text-muted">Release Date<br></span> October 19, 2016 </div> <div class="col-6 col-md-4"> <span class="text-muted">Genre<br></span> MMORPG </div> <div class="col-6 col-md-4"> <span class="text-muted">Platform<br></span> <i class="fab fa-windows mr-1"></i> Windows (Client) </div> </div>  <h2 class="h3 font-weight-dark text-center text-lg-left mt-5 mb-0">AdventureQuest 3D Screenshots</h2> <hr class="mt-2 mb-3"> <div class="row text-center text-lg-left"> <div class="col-lg-3 col-md-4 col-6"> <a href="g/89/AdventureQuest-3D-screenshots-1.jpg" data-lity class="d-block mb-3 h-100" alt="AdventureQuest 3D Gameplay Screenshot 1"> <img class="thumb-gallery shadow-sm rounded" src="g/89/AdventureQuest-3D-screenshots-1-small.jpg" alt="AdventureQuest 3D Thumbnail 1"> </a> </div> <div class="col-lg-3 col-md-4 col-6"> <a href="g/89/AdventureQuest-3D-screenshots-2.jpg" data-lity class="d-block mb-3 h-100" alt="AdventureQuest 3D Gameplay Screenshot 2"> <img class="thumb-gallery shadow-sm rounded" src="g/89/AdventureQuest-3D-screenshots-2-small.jpg" alt="AdventureQuest 3D Thumbnail 2"> </a> </div> <div class="col-lg-3 col-md-4 col-6"> <a href="g/89/AdventureQuest-3D-screenshots-3.jpg" data-lity class="d-block mb-3 h-100" alt="AdventureQuest 3D Gameplay Screenshot 3"> <img class="thumb-gallery shadow-sm rounded" src="g/89/AdventureQuest-3D-screenshots-3-small.jpg" alt="AdventureQuest 3D Thumbnail 3"> </a> </div> <div class="col-lg-3 col-md-4 col-6"> <a href="g/89/AdventureQuest-3D-screenshots-4.jpg" data-lity class="d-block mb-3 h-100" alt="AdventureQuest 3D Gameplay Screenshot 4"> <img class="thumb-gallery shadow-sm rounded" src="g/89/AdventureQuest-3D-screenshots-4-small.jpg" alt="AdventureQuest 3D Thumbnail 4"> </a> </div> </div>  <h2 class="h3 font-weight-dark text-center text-lg-left mt-5 mb-0">Minimum System Requirements <span class="small text-muted">(Windows)</span> </h2> <hr class="mt-2 mb-3"> <div class="row"> <div class="col-sm-6"> <span class="text-muted">OS<br></span> <p>Windows 7</p> <span class="text-muted">Memory<br></span> <p>1 GB RAM</p> <span class="text-muted">Storage<br></span> <p>500 MB available space</p> </div> <div class="col-sm-6"> <span class="text-muted">Processor<br></span> <p>Dual Core 1.8GHZ or Single Core 3.0GHZ</p> <span class="text-muted">Graphics<br></span> <p>512 MB</p> <span class="text-muted">Additional Notes<br></span> <p>Specifications may change during development</p> </div> </div>  <hr> <div class="text-muted small">All material on this page is copyrighted by ©Artix Entertainment and their respective licensors. All other trademarks are the property of their respective owners.</div>  <h2 class="h3 font-weight-dark text-center text-lg-left mt-5 mb-0">User Reviews</h2> <hr class="mt-2 mb-3"> <div class="reviews"> </div> <div class="row mt-2 align-items-center mb-5"> <div class="col text-muted justify-content-center">Play this game and post your review! </div> <div class="col-6"> <a class="btn btn-primary float-right" href="#submitReview" role="button">Submit Review</a> </div> </div>  <a href="like/adventurequest-3d.php" class="btn btn-outline-secondary btn-sm float-right">See All<i class="ml-1 fas fa-chevron-right"></i></a> <h2 class="h3">Games like AdventureQuest 3D</h2> <hr class="mt-2 mb-3"> <div class="row text-center text-lg-left"> <div class="game-card col-md-4 col-md-4 mb-4 video-card" data-video-src="/g/234/videoplayback.webm"> <div class="card grow shadow"> <div class="image-wrappers"> <img class="img2 card-img-top" width="262" height="148" src="g/234/thumbnail.jpg" alt="Champions of Regnum - A free to play, realm versus realm fantasy MMORPG."> <div class="loader-wrapper"> <div class="spinner-grow ftg-blue" role="status"> <span class="sr-only">Loading...</span> </div> </div> </div> <video class="featuredvideo3widget" loop preload="none" muted></video> <div class="card-body"> <span class="badge badge-ftg py-1 px-1 mt-1 float-right">FREE</span> <a href="champions-of-regnum.php" class="stretched-link no-underline"><h4 class="card-title text-truncate mb-n1">Champions of Regnum</h4></a> </div> </div> </div> <div class="game-card col-md-4 col-md-4 mb-4 video-card" data-video-src="/g/320/videoplayback.webm"> <div class="card grow shadow"> <div class="image-wrappers"> <img class="img2 card-img-top" width="262" height="148" src="g/320/thumbnail.jpg" alt="Dungeons and Dragons Online - A free-to-play MMORPG based on the beloved D&amp;D RPG that started it all."> <div class="loader-wrapper"> <div class="spinner-grow ftg-blue" role="status"> <span class="sr-only">Loading...</span> </div> </div> </div> <video class="featuredvideo3widget" loop preload="none" muted></video> <div class="card-body"> <span class="badge badge-ftg py-1 px-1 mt-1 float-right">FREE</span> <a href="dungeons-dragons-online.php" class="stretched-link no-underline"><h4 class="card-title text-truncate mb-n1">Dungeons and Dragons Online</h4></a> </div> </div> </div> <div class="game-card col-md-4 col-md-4 mb-4 video-card" data-video-src="/g/185/videoplayback.webm"> <div class="card grow shadow"> <div class="image-wrappers"> <img class="img2 card-img-top" width="262" height="148" src="g/185/thumbnail.jpg" alt="Eldevin - A indie story-driven Free to Play MMORPG."> <div class="loader-wrapper"> <div class="spinner-grow ftg-blue" role="status"> <span class="sr-only">Loading...</span> </div> </div> </div> <video class="featuredvideo3widget" loop preload="none" muted></video> <div class="card-body"> <span class="badge badge-ftg py-1 px-1 mt-1 float-right">FREE</span> <a href="eldevin.php" class="stretched-link no-underline"><h4 class="card-title text-truncate mb-n1">Eldevin</h4></a> </div> </div> </div> </div> </div> </div> </div> </div> </main> </body> 
<!-- Mirrored from www.freetogame.com/adventurequest-3d by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Mar 2024 08:10:20 GMT -->
