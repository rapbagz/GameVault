...
</div>  <main> <div class="container py-4 video-page"> <div class="gameprofile_background" style="background-image: url(g/241/background.webp);"> <div class="gameprofile_gradient"></div> </div> <div class="row">  <div class="col-md-4"> <div class="sidebar control-box"> <div class="card shadow mb-3 rounded"> <img class="img2 card-img-top progressive replace" width="331" height="201" src="g/241/thumbnail.jpg" alt="Everquest"> <video class="featuredvideo" loop preload="none" muted><source src="g/241/videoplayback.webm" type="video/webm"></source></video> </div> <div class="row"> <div class="col-3 col-lg-2 mr-2"> <span class="btn btn-dark2 mb-3">FREE</span> </div> <div class="col"> <a type="button" name="playnow" class="btn btn-ftg-blue btn-block" href="https://www.everquest.com/" rel="nofollow" target="_blank"><strong>PLAY NOW </strong><i class="fas fa-sign-out-alt"></i></a> </div> </div>  <div class="rate-section btn-group btn-block mb-3 text-center shadow-sm rounded"> 
...
<input type="hidden" id="gameId" value="149"> <!-- Replace 1 with the actual game ID -->
...
</script>  <h2 class="mt-4 h3">About Everquest</h2> <hr class="mt-2 mb-3"> <div id="summary"> <p class="collapse text-justify" id="collapseSummary"> EverQuest is a fantasy MMORPG nearly two decades in the making. In fact, it’s the game that started it all! No other MMORPG matches EverQuest’s content that includes 18 expansions, plus the original game. You are about to see what 16 years of continuous development of content can do for an online MMORPG.<br> <br> Developed and published by the team at Daybreak Games, EverQuest continues to add content and worlds full of mystery and adventure. EverQuest is currently free to Play, you will join a community that is unlike any other, as you immerse yourself in hundreds of battle zones, battling thousands of creatures, and complete quests with your friends.<br> <br> When playing EverQuest, you will be able to take advantage of the character system, customize your character with thousands of alternate abilities and build up through over 90 levels of power. In EverQuest, there are over 50,000 items you are able to collect and earn, and you are even able to hire and control unique mercenaries to aid you in your adventures. The in game marketplace is pretty impressive as well, as it contains potions, weapons, armor, and mounts!<br> <br> EverQuest is best enjoyed with friends, but you are still able to play Solo. If you ​are ​playing with friends though, you have options to play in groups and raid across continents filled with dungeons, crypts, floating landscapes, and underwater adventures. You can even participate in several seasonal and holiday events throughout the year. Are you ready to join the game that started it all, nearly two decades ago? </p> <a class="collapsed" data-toggle="collapse" href="#collapseSummary" aria-expanded="false" aria-controls="collapseSummary"></a> </div> <hr> <div class="text-muted disclosure"> <p>Disclosure: FreeToGame works closely with publishers and developers to offer a free and rewarding experience. In order to keep everything free to use we may sometimes earn a small commission from some partners. Find more info in our <a href="faq.php">FAQ</a> page. </p> <p> </p> </div>  <h2 class="mt-5 h3">Additional Information</h2> <div class="text-muted mt-n2"> <i class="fas fa-info-circle mr-2"></i>Please note this free-to-play game may or may not offer optional in-game purchases.</div> <hr class="mt-2 mb-3"> <div class="row mb-3"> <div class="col-6 col-md-4"> <span class="text-muted">Title<br></span> <p>Everquest</p> </div> <div class="col-6 col-md-4"> <span class="text-muted">Developer<br></span> Daybreak Games </div> <div class="col-6 col-md-4"> <span class="text-muted">Publisher<br></span> Daybreak Games </div> <div class="col-6 col-md-4"> <span class="text-muted">Release Date<br></span> December 13, 2012 </div> <div class="col-6 col-md-4"> <span class="text-muted">Genre<br></span> MMORPG </div> <div class="col-6 col-md-4"> <span class="text-muted">Platform<br></span> <i class="fab fa-windows mr-1"></i> Windows (Client) </div> </div>  <h2 class="h3 font-weight-dark text-center text-lg-left mt-5 mb-0">Everquest Screenshots</h2> <hr class="mt-2 mb-3"> <div class="row text-center text-lg-left"> <div class="col-lg-3 col-md-4 col-6"> <a href="g/241/Everquest-1.jpg" data-lity class="d-block mb-3 h-100" alt="Everquest Gameplay Screenshot 1"> <img class="thumb-gallery shadow-sm rounded" src="g/241/Everquest-1-small.jpg" alt="Everquest Thumbnail 1"> </a> </div> <div class="col-lg-3 col-md-4 col-6"> <a href="g/241/Everquest-2.jpg" data-lity class="d-block mb-3 h-100" alt="Everquest Gameplay Screenshot 2"> <img class="thumb-gallery shadow-sm rounded" src="g/241/Everquest-2-small.jpg" alt="Everquest Thumbnail 2"> </a> </div> <div class="col-lg-3 col-md-4 col-6"> <a href="g/241/Everquest-3.jpg" data-lity class="d-block mb-3 h-100" alt="Everquest Gameplay Screenshot 3"> <img class="thumb-gallery shadow-sm rounded" src="g/241/Everquest-3-small.jpg" alt="Everquest Thumbnail 3"> </a> </div> <div class="col-lg-3 col-md-4 col-6"> <a href="g/241/Everquest-4.jpg" data-lity class="d-block mb-3 h-100" alt="Everquest Gameplay Screenshot 4"> <img class="thumb-gallery shadow-sm rounded" src="g/241/Everquest-4-small.jpg" alt="Everquest Thumbnail 4"> </a> </div> </div>  <h2 class="h3 font-weight-dark text-center text-lg-left mt-5 mb-0">Minimum System Requirements <span class="small text-muted">(Windows)</span> </h2> <hr class="mt-2 mb-3"> <div class="row"> <div class="col-sm-6"> <span class="text-muted">OS<br></span> <p>Windows 7</p> <span class="text-muted">Memory<br></span> <p>2 GB</p> <span class="text-muted">Storage<br></span> <p>10 GB</p> </div> <div class="col-sm-6"> <span class="text-muted">Processor<br></span> <p>Intel Pentium® 4 / AMD Athlon 64</p> <span class="text-muted">Graphics<br></span> <p>NVIDIA Ti 4800 or ATI 9800 </p> <span class="text-muted">Additional Notes<br></span> <p>Specifications may change during development</p> </div> </div>  <hr> <div class="text-muted small">All material on this page is copyrighted by ©Daybreak Games and their respective licensors. All other trademarks are the property of their respective owners.</div>  <h2 class="h3 font-weight-dark text-center text-lg-left mt-5 mb-0">User Reviews</h2> <hr class="mt-2 mb-3"> <div class="reviews"> </div> <div class="row mt-2 align-items-center mb-5"> <div class="col text-muted justify-content-center">Play this game and post your review! </div> <div class="col-6"> <a class="btn btn-primary float-right" href="#submitReview" role="button">Submit Review</a> </div> </div>  <a href="like/everquest.php" class="btn btn-outline-secondary btn-sm float-right">See All<i class="ml-1 fas fa-chevron-right"></i></a> <h2 class="h3">Games like Everquest</h2> <hr class="mt-2 mb-3"> <div class="row text-center text-lg-left"> <div class="game-card col-md-4 col-md-4 mb-4 video-card" data-video-src="/g/287/videoplayback.webm"> <div class="card grow shadow"> <div class="image-wrappers"> <img class="img2 card-img-top" width="262" height="148" src="g/287/thumbnail.jpg" alt="Twelve Sky 2 - There’s a lot of world to explore in this fantasy MMORPG!"> <div class="loader-wrapper"> <div class="spinner-grow ftg-blue" role="status"> <span class="sr-only">Loading...</span> </div> </div> </div> <video class="featuredvideo3widget" loop preload="none" muted></video> <div class="card-body"> <span class="badge badge-ftg py-1 px-1 mt-1 float-right">FREE</span> <a href="twelve-sky-2.php" class="stretched-link no-underline"><h4 class="card-title text-truncate mb-n1">Twelve Sky 2</h4></a> </div> </div> </div> <div class="game-card col-md-4 col-md-4 mb-4 video-card" data-video-src="/g/307/videoplayback.webm"> <div class="card grow shadow"> <div class="image-wrappers"> <img class="img2 card-img-top" width="262" height="148" src="g/307/thumbnail.jpg" alt="Shaiya - A free to play 3D MMORPG similar to World of Warcraft and Lineage 2."> <div class="loader-wrapper"> <div class="spinner-grow ftg-blue" role="status"> <span class="sr-only">Loading...</span> </div> </div> </div> <video class="featuredvideo3widget" loop preload="none" muted></video> <div class="card-body"> <span class="badge badge-ftg py-1 px-1 mt-1 float-right">FREE</span> <a href="shaiya.php" class="stretched-link no-underline"><h4 class="card-title text-truncate mb-n1">Shaiya</h4></a> </div> </div> </div> <div class="game-card col-md-4 col-md-4 mb-4 video-card" data-video-src="/g/234/videoplayback.webm"> <div class="card grow shadow"> <div class="image-wrappers"> <img class="img2 card-img-top" width="262" height="148" src="g/234/thumbnail.jpg" alt="Champions of Regnum - A free to play, realm versus realm fantasy MMORPG."> <div class="loader-wrapper"> <div class="spinner-grow ftg-blue" role="status"> <span class="sr-only">Loading...</span> </div> </div> </div> <video class="featuredvideo3widget" loop preload="none" muted></video> <div class="card-body"> <span class="badge badge-ftg py-1 px-1 mt-1 float-right">FREE</span> <a href="champions-of-regnum.php" class="stretched-link no-underline"><h4 class="card-title text-truncate mb-n1">Champions of Regnum</h4></a> </div> </div> </div> </div> </div> </div> </div> </div> </main> </body> 
<!-- Mirrored from www.freetogame.com/everquest by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Mar 2024 08:20:54 GMT -->
