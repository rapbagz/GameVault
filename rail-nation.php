...
<input type="hidden" id="gameId" value="312"> <!-- Replace 1 with the actual game ID -->
...
<script>
  ...
  <h2 class="mt-4 h3">About Rail Nation</h2> <hr class="mt-2 mb-3"> <div id="summary"> <p class="collapse text-justify" id="collapseSummary"> Rail Nation is a free to play 2D browser-based train simulation strategy MMO game, published by Travian Games and developed by Bright Future. Rail Nation offers players the ability to choose between the opposing factions Eastern Atlantic Railway or the Western Pacific Railroad, each seeking to control the rail system and expand their network of trains as they progress through the game.<br> <br> Players initially pick a hub city and start with a basic train route. Then they must gather resources by planning their routes, delivering goods and building additional tracks to connect their network to more and more American cities. After starting with steam engines, players can research more advance technologies and upgrade to diesel and electric trains to enhance their networks’ capabilities.<br> <br> This train simulation game spans across six eras as server time passes. Eras last two weeks, and will progress as server time passes, regardless of whether people are actively playing. The game’s cities are composed of groups of players, and the final era is a competition between the 10 top-ranked cities. Each era offers more trains to choose from and subsequently more ways to deliver goods for profit. Players can build and upgrade structures in their train station houses including a laboratories, lottery buildings and engine sheds. The game boasts historical accuracy, a decent player base and loads of content to keep players engaged. </p> <a class="collapsed" data-toggle="collapse" href="#collapseSummary" aria-expanded="false" aria-controls="collapseSummary"></a> </div> <hr> <div class="text-muted disclosure"> <p>Disclosure: FreeToGame works closely with publishers and developers to offer a free and rewarding experience. In order to keep everything free to use we may sometimes earn a small commission from some partners. Find more info in our <a href="faq.php">FAQ</a> page. </p> <p> </p> </div>  <h2 class="mt-5 h3">Additional Information</h2> <div class="text-muted mt-n2"> <i class="fas fa-info-circle mr-2"></i>Please note this free-to-play game may or may not offer optional in-game purchases.</div> <hr class="mt-2 mb-3"> <div class="row mb-3"> <div class="col-6 col-md-4"> <span class="text-muted">Title<br></span> <p>Rail Nation</p> </div> <div class="col-6 col-md-4"> <span class="text-muted">Developer<br></span> Travian Games </div> <div class="col-6 col-md-4"> <span class="text-muted">Publisher<br></span> Bright Future </div> <div class="col-6 col-md-4"> <span class="text-muted">Release Date<br></span> January 13, 2013 </div> <div class="col-6 col-md-4"> <span class="text-muted">Genre<br></span> Strategy </div> <div class="col-6 col-md-4"> <span class="text-muted">Platform<br></span> <i class="fas fa-window-maximize"></i> Web Browser </div> </div>  <h2 class="h3 font-weight-dark text-center text-lg-left mt-5 mb-0">Rail Nation Screenshots</h2> <hr class="mt-2 mb-3"> <div class="row text-center text-lg-left"> <div class="col-lg-4 col-md-4 col-6"> <a href="g/414/Rail-Nation-1.jpg" data-lity class="d-block mb-3 h-100" alt="Rail Nation Gameplay Screenshot 1"> <img class="thumb-gallery shadow-sm rounded" src="g/414/Rail-Nation-1-small.jpg" alt="Rail Nation Thumbnail 1"> </a> </div> <div class="col-lg-4 col-md-4 col-6"> <a href="g/414/Rail-Nation-2.jpg" data-lity class="d-block mb-3 h-100" alt="Rail Nation Gameplay Screenshot 2"> <img class="thumb-gallery shadow-sm rounded" src="g/414/Rail-Nation-2-small.jpg" alt="Rail Nation Thumbnail 2"> </a> </div> <div class="col-lg-4 col-md-4 col-6"> <a href="g/414/Rail-Nation-3.jpg" data-lity class="d-block mb-3 h-100" alt="Rail Nation Gameplay Screenshot 3"> <img class="thumb-gallery shadow-sm rounded" src="g/414/Rail-Nation-3-small.jpg" alt="Rail Nation Thumbnail 3"> </a> </div> </div>  <h2 class="font-weight-dark h3 text-center text-lg-left mt-5 mb-0">Minimum System Requirements <span class="small text-muted">(Browser)</span> </h2> <hr class="mt-2 mb-3"> <span class="text-muted text"><p>Rail Nation is a browser based game and should run smoothly on practically any PC with a updated web-browser.</p> <p>If you have old hardware or software, you may still be able to play Rail Nation, but your game experience may suffer. For the best gameplay experience, we recommend the latest versions of Firefox, Chrome, or Internet Explorer.</p> </span>  <hr> <div class="text-muted small">All material on this page is copyrighted by ©Bright Future and their respective licensors. All other trademarks are the property of their respective owners.</div>  <h2 class="h3 font-weight-dark text-center text-lg-left mt-5 mb-0">User Reviews</h2> <hr class="mt-2 mb-3"> <div class="reviews"> </div> <div class="row mt-2 align-items-center mb-5"> <div class="col text-muted justify-content-center">Play this game and post your review! </div> <div class="col-6"> <a class="btn btn-primary float-right" href="#submitReview" role="button">Submit Review</a> </div> </div>  <a href="like/rail-nation.php" class="btn btn-outline-secondary btn-sm float-right">See All<i class="ml-1 fas fa-chevron-right"></i></a> <h2 class="h3">Games like Rail Nation</h2> <hr class="mt-2 mb-3"> <div class="row text-center text-lg-left"> <div class="game-card col-md-4 col-md-4 mb-4 "> <div class="card grow shadow"> <div class="image-wrappers"> <img class="img2 card-img-top" width="262" height="148" src="g/457/thumbnail.jpg" alt="The Third Age - A free-to-play browser-based Strategy MMO game focused on story-based PvE gameplay!"> <div class="loader-wrapper"> <div class="spinner-grow ftg-blue" role="status"> <span class="sr-only">Loading...</span> </div> </div> </div> <video class="featuredvideo" loop preload="none" muted></video> <div class="card-body"> <span class="badge badge-ftg py-1 px-1 mt-1 float-right">FREE</span> <a href="the-third-age.php" class="stretched-link no-underline"><h4 class="card-title text-truncate mb-n1">The Third Age</h4></a> </div> </div> </div> <div class="game-card col-md-4 col-md-4 mb-4 video-card" data-video-src="/g/428/videoplayback.webm"> <div class="card grow shadow"> <div class="image-wrappers"> <img class="img2 card-img-top" width="262" height="148" src="g/428/thumbnail.jpg" alt="Ikariam - A free to play browser-based city-building strategy game by GameForge."> <div class="loader-wrapper"> <div class="spinner-grow ftg-blue" role="status"> <span class="sr-only">Loading...</span> </div> </div> </div> <video class="featuredvideo3widget" loop preload="none" muted></video> <div class="card-body"> <span class="badge badge-ftg py-1 px-1 mt-1 float-right">FREE</span> <a href="ikariam.php" class="stretched-link no-underline"><h4 class="card-title text-truncate mb-n1">Ikariam</h4></a> </div> </div> </div> <div class="game-card col-md-4 col-md-4 mb-4 video-card" data-video-src="/g/404/videoplayback.webm"> <div class="card grow shadow"> <div class="image-wrappers"> <img class="img2 card-img-top" width="262" height="148" src="g/404/thumbnail.jpg" alt="Tribal Wars 2 - The sequel to the classic city-building strategy game Tribal Wars! "> <div class="loader-wrapper"> <div class="spinner-grow ftg-blue" role="status"> <span class="sr-only">Loading...</span> </div> </div> </div> <video class="featuredvideo3widget" loop preload="none" muted></video> <div class="card-body"> <span class="badge badge-ftg py-1 px-1 mt-1 float-right">FREE</span> <a href="tribal-wars-2.php" class="stretched-link no-underline"><h4 class="card-title text-truncate mb-n1">Tribal Wars 2</h4></a> </div> </div> </div> </div> </div> </div> </div> </div> </main> </body> 
<!-- Mirrored from www.freetogame.com/rail-nation by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Mar 2024 08:07:28 GMT -->
