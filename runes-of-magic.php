...
</div>  <main> <div class="container py-4 video-page"> <div class="gameprofile_background" style="background-image: url(g/290/background.webp);"> <div class="gameprofile_gradient"></div> </div> <div class="row">  <div class="col-md-4"> <div class="sidebar control-box"> <div class="card shadow mb-3 rounded"> <img class="img2 card-img-top progressive replace" width="331" height="201" src="g/290/thumbnail.jpg" alt="Runes of Magic"> <video class="featuredvideo" loop preload="none" muted><source src="g/290/videoplayback.webm" type="video/webm"></source></video> </div> <div class="row"> <div class="col-3 col-lg-2 mr-2"> <span class="btn btn-dark2 mb-3">FREE</span> </div> <div class="col"> <a type="button" name="playnow" class="btn btn-ftg-blue btn-block" href="https://us.runesofmagic.gameforge.com/" rel="nofollow" target="_blank"><strong>PLAY NOW </strong><i class="fas fa-sign-out-alt"></i></a> </div> </div>  <div class="rate-section btn-group btn-block mb-3 text-center shadow-sm rounded"> <!-- Reaction Buttons -->
...
<input type="hidden" id="gameId" value="335"> <!-- Replace 1 with the actual game ID -->
...
</script> <div class="dropdown-menu shadow" aria-labelledby="btnGroupDrop1" x-placement="bottom-start"> <a class="dropdown-item" onclick="notSignedIn()"><i class="fas fa-gamepad pr-1"></i> Currently Playing</a> <a class="dropdown-item" onclick="notSignedIn()"><i class="fas fa-check pr-1"></i> Played</a> <a class="dropdown-item" onclick="notSignedIn()"><i class="fas fa-trophy pr-1"></i> Completed</a> <a class="dropdown-item" onclick="notSignedIn()"><i class="far fa-clock pr-1"></i> Play Later</a> </div> </div>  <span class="small text-muted ml-1"><i class="fas fa-user mr-2"></i>Requires 3rd-Party Account</span> </div> </div>   <div class="col-md-8">  <nav aria-label="breadcrumb"> <ul class="breadcrumb2 small mb-0"> <li class="breadcrumb-item2"><a class="nocolor" href="index.php">Home</a></li> <li class="breadcrumb-item2"><a class="nocolor" href="games.php">Free Games</a></li> <li class="breadcrumb-item2 text-muted" aria-current="page">Runes of Magic</li> </ul> </nav> <style>.breadcrumb2{list-style:none;padding:0}.breadcrumb-item2{display:inline-block}.breadcrumb-item2::after{content:">";margin-left:2px}.breadcrumb-item2:last-child::after{content:""}</style> <h1>Runes of Magic</h1>  <div class="row py-3"> <div class="col-md-7"> <div class="statRightHolder mb-2"> <ul class="statsLeft2"> <h4> <span class="blue"><i class="fas fa-thumbs-up mr-2"></i></span><span>Positive</span> </h4> <li> <span class="mr-2">4</span><span>Member Ratings</span> </li> </ul> <ul class="statsLeft2"> <li> <span class="yellow"><i class="far fa-user mr-2"></i> 32</span> Members have this game in their library!</li> </ul> <ul class="statsLeft"> <li> <span class="red"><i class="far fa-comment-alt mr-2"></i> 0</span> Reviews</li> </ul> <ul class="statsRight"> <li> <span><i class="fas fa-long-arrow-alt-down"></i> 75%</span><span class="ml-1">Popularity</span> </li> </ul> </div> </div>  <div class="col"> <div class="d-flex justify-content-center align-middle"> <div class="progress-pie-chart" data-percent="67">  <div class="ppc-progress"> <div class="ppc-progress-fill"></div> </div> <div class="ppc-percents"> <div class="pcc-percents-wrapper"> <span class="small">%</span> </div> </div> </div> </div> </div> </div>   <div id="submitReview" class="anchor mt-3"> <span class="float-right"><div class="rating"> <h2 class="d-flex flex-row mr-2 h4">Feel free to share your reviews! </h2> </div></span> <h2 class="d-flex flex-row mr-2 h4">What do you think about Runes of Magic? </h2> 
...
<script>
    ...
    window.addEventListener('load', loadUserThoughts);
     ...
     <h2 class="mt-4 h3">About Runes of Magic</h2> <hr class="mt-2 mb-3"> <div id="summary"> <p class="collapse text-justify" id="collapseSummary"> Runes of Magic is a free-to-play fantasy 3D MMORPG brought to you by Runewalker Entertainment. Set in the fantasy world of Taborea, Runes of Magic allows players to choose between three races and ten different classes with an additional multiple class system. Both the races and classes are relatively standard for an MMORPG and determine the players starting area although there is the ability to customize class skills.<br> <br> Character creation allows for some appearance customization such as choice of hairstyle and the standard modification sliding bars. Most of the customization comes from choosing a class based on its unique skill set and once the player has reached level 10 the ability to choose a secondary class is available. Combining the skill sets creates 60 different possibilities and can adapt the game to fit each player’s own play style. Choosing this secondary class gives a stat boost to the main class, an additional set of sub abilities to add to the main set, and different combinations can unlock elite skills at specific levels. Each class must be leveled separately and the secondary class is always capped at the level of the main class.<br> <br> Runes of Magic features over 4,000 quests for adventurers to complete, a series of epic quests, over 20 instances and raids, and a unique crafting system. The crafting system features 9 professions to choose from based on what you feel your character can use to benefit them the most. There is also an extensive pet and mount system, a housing system, and several different PvP modes. </p> <a class="collapsed" data-toggle="collapse" href="#collapseSummary" aria-expanded="false" aria-controls="collapseSummary"></a> </div> <hr> <div class="text-muted disclosure"> <p>Disclosure: FreeToGame works closely with publishers and developers to offer a free and rewarding experience. In order to keep everything free to use we may sometimes earn a small commission from some partners. Find more info in our <a href="faq.php">FAQ</a> page. </p> <p> </p> </div>  <h2 class="mt-5 h3">Additional Information</h2> <div class="text-muted mt-n2"> <i class="fas fa-info-circle mr-2"></i>Please note this free-to-play game may or may not offer optional in-game purchases.</div> <hr class="mt-2 mb-3"> <div class="row mb-3"> <div class="col-6 col-md-4"> <span class="text-muted">Title<br></span> <p>Runes of Magic</p> </div> <div class="col-6 col-md-4"> <span class="text-muted">Developer<br></span> Runewalker Entertainment </div> <div class="col-6 col-md-4"> <span class="text-muted">Publisher<br></span> GameForge </div> <div class="col-6 col-md-4"> <span class="text-muted">Release Date<br></span> March 19, 2009 </div> <div class="col-6 col-md-4"> <span class="text-muted">Genre<br></span> MMORPG </div> <div class="col-6 col-md-4"> <span class="text-muted">Platform<br></span> <i class="fab fa-windows mr-1"></i> Windows (Client) </div> </div>  <h2 class="h3 font-weight-dark text-center text-lg-left mt-5 mb-0">Runes of Magic Screenshots</h2> <hr class="mt-2 mb-3"> <div class="row text-center text-lg-left"> <div class="col-lg-3 col-md-4 col-6"> <a href="g/290/Runes-of-Magic-1.jpg" data-lity class="d-block mb-3 h-100" alt="Runes of Magic Gameplay Screenshot 1"> <img class="thumb-gallery shadow-sm rounded" src="g/290/Runes-of-Magic-1-small.jpg" alt="Runes of Magic Thumbnail 1"> </a> </div> <div class="col-lg-3 col-md-4 col-6"> <a href="g/290/Runes-of-Magic-2.jpg" data-lity class="d-block mb-3 h-100" alt="Runes of Magic Gameplay Screenshot 2"> <img class="thumb-gallery shadow-sm rounded" src="g/290/Runes-of-Magic-2-small.jpg" alt="Runes of Magic Thumbnail 2"> </a> </div> <div class="col-lg-3 col-md-4 col-6"> <a href="g/290/Runes-of-Magic-3.jpg" data-lity class="d-block mb-3 h-100" alt="Runes of Magic Gameplay Screenshot 3"> <img class="thumb-gallery shadow-sm rounded" src="g/290/Runes-of-Magic-3-small.jpg" alt="Runes of Magic Thumbnail 3"> </a> </div> <div class="col-lg-3 col-md-4 col-6"> <a href="g/290/Runes-of-Magic-4.jpg" data-lity class="d-block mb-3 h-100" alt="Runes of Magic Gameplay Screenshot 4"> <img class="thumb-gallery shadow-sm rounded" src="g/290/Runes-of-Magic-4-small.jpg" alt="Runes of Magic Thumbnail 4"> </a> </div> </div>  <h2 class="h3 font-weight-dark text-center text-lg-left mt-5 mb-0">Minimum System Requirements <span class="small text-muted">(Windows)</span> </h2> <hr class="mt-2 mb-3"> <div class="row"> <div class="col-sm-6"> <span class="text-muted">OS<br></span> <p>Windows XP / Vista / 7 / 8</p> <span class="text-muted">Memory<br></span> <p>2 GB</p> <span class="text-muted">Storage<br></span> <p>15GB</p> </div> <div class="col-sm-6"> <span class="text-muted">Processor<br></span> <p>Intel Core 2 Duo 2 GHz of better</p> <span class="text-muted">Graphics<br></span> <p>GeForce 6800 / ATI X800 or better</p> <span class="text-muted">Additional Notes<br></span> <p>Specifications may change during development</p> </div> </div>  <hr> <div class="text-muted small">All material on this page is copyrighted by ©GameForge and their respective licensors. All other trademarks are the property of their respective owners.</div>  <h2 class="h3 font-weight-dark text-center text-lg-left mt-5 mb-0">User Reviews</h2> <hr class="mt-2 mb-3"> <div class="reviews"> </div> <div class="row mt-2 align-items-center mb-5"> <div class="col text-muted justify-content-center">Play this game and post your review! </div> <div class="col-6"> <a class="btn btn-primary float-right" href="#submitReview" role="button">Submit Review</a> </div> </div>  <a href="like/runes-of-magic.php" class="btn btn-outline-secondary btn-sm float-right">See All<i class="ml-1 fas fa-chevron-right"></i></a> <h2 class="h3">Games like Runes of Magic</h2> <hr class="mt-2 mb-3"> <div class="row text-center text-lg-left"> <div class="game-card col-md-4 col-md-4 mb-4 video-card" data-video-src="/g/11/videoplayback.webm"> <div class="card grow shadow"> <div class="image-wrappers"> <img class="img2 card-img-top" width="262" height="148" src="g/11/thumbnail.jpg" alt="Neverwinter - A free-to-play 3D action MMORPG based on the acclaimed Dungeons &amp; Dragons fantasy roleplaying game. "> <div class="loader-wrapper"> <div class="spinner-grow ftg-blue" role="status"> <span class="sr-only">Loading...</span> </div> </div> </div> <video class="featuredvideo3widget" loop preload="none" muted></video> <div class="card-body"> <span class="badge badge-ftg py-1 px-1 mt-1 float-right">FREE</span> <a href="neverwinter.php" class="stretched-link no-underline"><h4 class="card-title text-truncate mb-n1">Neverwinter</h4></a> </div> </div> </div> <div class="game-card col-md-4 col-md-4 mb-4 video-card" data-video-src="/g/10/videoplayback.webm"> <div class="card grow shadow"> <div class="image-wrappers"> <img class="img2 card-img-top" width="262" height="148" src="g/10/thumbnail.jpg" alt="ArcheAge - A free-to-play, hybrid fantasy/sandbox MMORPG brought to you by Trion Worlds."> <div class="loader-wrapper"> <div class="spinner-grow ftg-blue" role="status"> <span class="sr-only">Loading...</span> </div> </div> </div> <video class="featuredvideo3widget" loop preload="none" muted></video> <div class="card-body"> <span class="badge badge-ftg py-1 px-1 mt-1 float-right">FREE</span> <a href="archeage.php" class="stretched-link no-underline"><h4 class="card-title text-truncate mb-n1">ArcheAge</h4></a> </div> </div> </div> <div class="game-card col-md-4 col-md-4 mb-4 video-card" data-video-src="/g/277/videoplayback.webm"> <div class="card grow shadow"> <div class="image-wrappers"> <img class="img2 card-img-top" width="262" height="148" src="g/277/thumbnail.jpg" alt="Aika Online - A free-to-play MMORPG with large scale PvP battles."> <div class="loader-wrapper"> <div class="spinner-grow ftg-blue" role="status"> <span class="sr-only">Loading...</span> </div> </div> </div> <video class="featuredvideo3widget" loop preload="none" muted></video> <div class="card-body"> <span class="badge badge-ftg py-1 px-1 mt-1 float-right">FREE</span> <a href="aika-online.php" class="stretched-link no-underline"><h4 class="card-title text-truncate mb-n1">Aika Online</h4></a> </div> </div> </div> </div> </div> </div> </div> </div> </main> </body> 
<!-- Mirrored from www.freetogame.com/runes-of-magic by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Mar 2024 08:34:14 GMT -->
