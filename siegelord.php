...
</div>  <main> <div class="container py-4 video-page"> <div class="gameprofile_background" style="background-image: url(g/399/background.webp);"> <div class="gameprofile_gradient"></div> </div> <div class="row">  <div class="col-md-4"> <div class="sidebar control-box"> <div class="card shadow mb-3 rounded"> <img class="img2 card-img-top progressive replace" width="331" height="201" src="g/399/thumbnail.jpg" alt="Siegelord"> <video class="featuredvideo" loop preload="none" muted><source src="g/399/videoplayback.webm" type="video/webm"></source></video> </div> <div class="row"> <div class="col-3 col-lg-2 mr-2"> <span class="btn btn-dark2 mb-3">FREE</span> </div> <div class="col"> <a type="button" name="playnow" class="btn btn-ftg-blue btn-block" href="https://siegelord.amzgame.com/" rel="nofollow" target="_blank"><strong>PLAY NOW </strong><i class="fas fa-sign-out-alt"></i></a> </div> </div>  <div class="rate-section btn-group btn-block mb-3 text-center shadow-sm rounded"> <!-- Reaction Buttons -->
...
<input type="hidden" id="gameId" value="354"> <!-- Replace 1 with the actual game ID -->
...
<script>
 ...
 <h2 class="mt-4 h3">About Siegelord</h2> <hr class="mt-2 mb-3"> <div id="summary"> <p class="collapse text-justify" id="collapseSummary"> Siegelord is a free to play 2D medieval fantasy browser-based MMORTS, players compete with other players by expanding the cities they initially start the game with into vast empires. Published by 37 Games Entertainment, the RTS game is a mix of strategy and civilization building. To generate resources, you must construct certain buildings on the land you currently have available to prepare for real-time battles with other players. The battles are simple and somewhat automated. However, you will need to ensure your settlement is prepared well enough to offer the support you’ll need during combat in the form of resources, equipment and troop-enhancing technologies.<br> <br> Siegelord is set in a medieval fantasy world where three opposing empires, the Albion, Nords Alliance and the Empire of Gorm, fight for territorial domination. Players must choose a faction to fight for, and recruit and equip generals to offer support to your troops in battle. Generals are unlocked throughout the game and offer skills and equipment. You can play through the single-player campaign, or fight other players for territorial control. While battling other players, you must choose the proper formation for your troops (assault, attack or defense) to seize victory. Stay frosty, as the borders of the land of Theiden shift perpetually as players conquer new territory. </p> <a class="collapsed" data-toggle="collapse" href="#collapseSummary" aria-expanded="false" aria-controls="collapseSummary"></a> </div> <hr> <div class="text-muted disclosure"> <p>Disclosure: FreeToGame works closely with publishers and developers to offer a free and rewarding experience. In order to keep everything free to use we may sometimes earn a small commission from some partners. Find more info in our <a href="faq.php">FAQ</a> page. </p> <p> </p> </div>  <h2 class="mt-5 h3">Additional Information</h2> <div class="text-muted mt-n2"> <i class="fas fa-info-circle mr-2"></i>Please note this free-to-play game may or may not offer optional in-game purchases.</div> <hr class="mt-2 mb-3"> <div class="row mb-3"> <div class="col-6 col-md-4"> <span class="text-muted">Title<br></span> <p>Siegelord</p> </div> <div class="col-6 col-md-4"> <span class="text-muted">Developer<br></span> 37Games Entertainment </div> <div class="col-6 col-md-4"> <span class="text-muted">Publisher<br></span> 37Games Entertainment </div> <div class="col-6 col-md-4"> <span class="text-muted">Release Date<br></span> December 19, 2014 </div> <div class="col-6 col-md-4"> <span class="text-muted">Genre<br></span> Strategy </div> <div class="col-6 col-md-4"> <span class="text-muted">Platform<br></span> <i class="fas fa-window-maximize"></i> Web Browser </div> </div>  <h2 class="h3 font-weight-dark text-center text-lg-left mt-5 mb-0">Siegelord Screenshots</h2> <hr class="mt-2 mb-3"> <div class="row text-center text-lg-left"> <div class="col-lg-4 col-md-4 col-6"> <a href="g/399/Siegelord-1.jpg" data-lity class="d-block mb-3 h-100" alt="Siegelord Gameplay Screenshot 1"> <img class="thumb-gallery shadow-sm rounded" src="g/399/Siegelord-1-small.jpg" alt="Siegelord Thumbnail 1"> </a> </div> <div class="col-lg-4 col-md-4 col-6"> <a href="g/399/Siegelord-2.jpg" data-lity class="d-block mb-3 h-100" alt="Siegelord Gameplay Screenshot 2"> <img class="thumb-gallery shadow-sm rounded" src="g/399/Siegelord-2-small.jpg" alt="Siegelord Thumbnail 2"> </a> </div> <div class="col-lg-4 col-md-4 col-6"> <a href="g/399/Siegelord-3.jpg" data-lity class="d-block mb-3 h-100" alt="Siegelord Gameplay Screenshot 3"> <img class="thumb-gallery shadow-sm rounded" src="g/399/Siegelord-3-small.jpg" alt="Siegelord Thumbnail 3"> </a> </div> </div>  <h2 class="font-weight-dark h3 text-center text-lg-left mt-5 mb-0">Minimum System Requirements <span class="small text-muted">(Browser)</span> </h2> <hr class="mt-2 mb-3"> <span class="text-muted text"><p>Siegelord is a browser based game and should run smoothly on practically any PC with a updated web-browser.</p> <p>If you have old hardware or software, you may still be able to play Siegelord, but your game experience may suffer. For the best gameplay experience, we recommend the latest versions of Firefox, Chrome, or Internet Explorer.</p> </span>  <hr> <div class="text-muted small">All material on this page is copyrighted by ©37Games Entertainment and their respective licensors. All other trademarks are the property of their respective owners.</div>  <h2 class="h3 font-weight-dark text-center text-lg-left mt-5 mb-0">User Reviews</h2> <hr class="mt-2 mb-3"> <div class="reviews"> </div> <div class="row mt-2 align-items-center mb-5"> <div class="col text-muted justify-content-center">Play this game and post your review! </div> <div class="col-6"> <a class="btn btn-primary float-right" href="#submitReview" role="button">Submit Review</a> </div> </div>  <a href="like/siegelord.php" class="btn btn-outline-secondary btn-sm float-right">See All<i class="ml-1 fas fa-chevron-right"></i></a> <h2 class="h3">Games like Siegelord</h2> <hr class="mt-2 mb-3"> <div class="row text-center text-lg-left"> <div class="game-card col-md-4 col-md-4 mb-4 video-card" data-video-src="/g/347/videoplayback.webm"> <div class="card grow shadow"> <div class="image-wrappers"> <img class="img2 card-img-top" width="262" height="148" src="g/347/thumbnail.jpg" alt="Elvenar - A browser based city-building strategy MMO set in the fantasy world of Elvenar."> <div class="loader-wrapper"> <div class="spinner-grow ftg-blue" role="status"> <span class="sr-only">Loading...</span> </div> </div> </div> <video class="featuredvideo3widget" loop preload="none" muted></video> <div class="card-body"> <span class="badge badge-ftg py-1 px-1 mt-1 float-right">FREE</span> <a href="elvenar.php" class="stretched-link no-underline"><h4 class="card-title text-truncate mb-n1">Elvenar</h4></a> </div> </div> </div> <div class="game-card col-md-4 col-md-4 mb-4 video-card" data-video-src="/g/415/videoplayback.webm"> <div class="card grow shadow"> <div class="image-wrappers"> <img class="img2 card-img-top" width="262" height="148" src="g/415/thumbnail.jpg" alt="Stormfall: Age of War - A free to play 2D top-down browser MMORTS featuring castle building, resource management and PvP battles."> <div class="loader-wrapper"> <div class="spinner-grow ftg-blue" role="status"> <span class="sr-only">Loading...</span> </div> </div> </div> <video class="featuredvideo3widget" loop preload="none" muted></video> <div class="card-body"> <span class="badge badge-ftg py-1 px-1 mt-1 float-right">FREE</span> <a href="stormfall-age-war.php" class="stretched-link no-underline"><h4 class="card-title text-truncate mb-n1">Stormfall: Age of War</h4></a> </div> </div> </div> <div class="game-card col-md-4 col-md-4 mb-4 video-card" data-video-src="/g/431/videoplayback.webm"> <div class="card grow shadow"> <div class="image-wrappers"> <img class="img2 card-img-top" width="262" height="148" src="g/431/thumbnail.jpg" alt="Imperia Online - A 2D free-to-play browser-based Medieval MMORTS, Train soldiers and raise an Empire."> <div class="loader-wrapper"> <div class="spinner-grow ftg-blue" role="status"> <span class="sr-only">Loading...</span> </div> </div> </div> <video class="featuredvideo3widget" loop preload="none" muted></video> <div class="card-body"> <span class="badge badge-ftg py-1 px-1 mt-1 float-right">FREE</span> <a href="imperia-online.php" class="stretched-link no-underline"><h4 class="card-title text-truncate mb-n1">Imperia Online</h4></a> </div> </div> </div> </div> </div> </div> </div> </div> </main> </body> 
<!-- Mirrored from www.freetogame.com/siegelord by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Mar 2024 08:06:38 GMT -->
