...
</div>  <main> <div class="container py-4 video-page"> <div class="gameprofile_background" style="background-image: url();"> <div class="gameprofile_gradient"></div> </div> <div class="row">  <div class="col-md-4"> <div class="sidebar control-box"> <div class="card shadow mb-3 rounded"> <img class="img2 card-img-top progressive replace" width="331" height="201" src="g/339/thumbnail.jpg" alt="Tibia"> <video class="featuredvideo" loop preload="none" muted><source src="g/339/videoplayback.webm" type="video/webm"></source></video> </div> <div class="row"> <div class="col-3 col-lg-2 mr-2"> <span class="btn btn-dark2 mb-3">FREE</span> </div> <div class="col"> <a type="button" name="playnow" class="btn btn-ftg-blue btn-block" href="https://www.tibia.com/" rel="nofollow" target="_blank"><strong>PLAY NOW </strong><i class="fas fa-sign-out-alt"></i></a> </div> </div>  <div class="rate-section btn-group btn-block mb-3 text-center shadow-sm rounded"> <!-- Reaction Buttons -->
...
<input type="hidden" id="gameId" value="406"> <!-- Replace 1 with the actual game ID -->
...
</script> <div class="dropdown-menu shadow" aria-labelledby="btnGroupDrop1" x-placement="bottom-start"> <a class="dropdown-item" onclick="notSignedIn()"><i class="fas fa-gamepad pr-1"></i> Currently Playing</a> <a class="dropdown-item" onclick="notSignedIn()"><i class="fas fa-check pr-1"></i> Played</a> <a class="dropdown-item" onclick="notSignedIn()"><i class="fas fa-trophy pr-1"></i> Completed</a> <a class="dropdown-item" onclick="notSignedIn()"><i class="far fa-clock pr-1"></i> Play Later</a> </div> </div>  <span class="small text-muted ml-1"><i class="fas fa-user mr-2"></i>Requires 3rd-Party Account</span> </div> </div>   <div class="col-md-8">  <nav aria-label="breadcrumb"> <ul class="breadcrumb2 small mb-0"> <li class="breadcrumb-item2"><a class="nocolor" href="index.php">Home</a></li> <li class="breadcrumb-item2"><a class="nocolor" href="games.php">Free Games</a></li> <li class="breadcrumb-item2 text-muted" aria-current="page">Tibia</li> </ul> </nav> <style>.breadcrumb2{list-style:none;padding:0}.breadcrumb-item2{display:inline-block}.breadcrumb-item2::after{content:">";margin-left:2px}.breadcrumb-item2:last-child::after{content:""}</style> <h1>Tibia</h1>  <div class="row py-3"> <div class="col-md-7"> <div class="statRightHolder mb-2"> <ul class="statsLeft2"> <h4> <span class="blue"><i class="far fa-meh mr-2"></i></span><span>Mixed</span> </h4> <li> <span class="mr-2">3</span><span>Member Ratings</span> </li> </ul> <ul class="statsLeft2"> <li> <span class="yellow"><i class="far fa-user mr-2"></i> 24</span> Members have this game in their library!</li> </ul> <ul class="statsLeft"> <li> <span class="red"><i class="far fa-comment-alt mr-2"></i> 2</span> Reviews</li> </ul> <ul class="statsRight"> <li> <span><i class="fas fa-long-arrow-alt-down"></i> 38%</span><span class="ml-1">Popularity</span> </li> </ul> </div> </div>  <div class="col"> <div class="d-flex justify-content-center align-middle"> <div class="progress-pie-chart" data-percent="50">  <div class="ppc-progress"> <div class="ppc-progress-fill"></div> </div> <div class="ppc-percents"> <div class="pcc-percents-wrapper"> <span class="small">%</span> </div> </div> </div> </div> </div> </div>   <div id="submitReview" class="anchor mt-3"> <span class="float-right"><div class="rating"> <h2 class="d-flex flex-row mr-2 h4">Feel free to share your reviews! </h2> </div></span> <h2 class="d-flex flex-row mr-2 h4">What do you think about Tibia? </h2><!-- Updated input section for user's thoughts -->
...
</script> <h2 class="mt-4 h3">About Tibia</h2> <hr class="mt-2 mb-3"> <div id="summary"> <p class="collapse text-justify" id="collapseSummary"> Tibia is a old-school free-to-play massively multiplayer online role-playing game that was released in January 1997. Sporting 2D graphics, Tibia has low system requirements making it easy for anyone with a computer to play, regardless of how outdated their PC is.<br> <br> Set in a medieval world, players can choose one of four classes or “vocations”: Knight, Paladin, Sorcerer, or Druid. In addition, each vocation has access to two types of magic: Instant Magic, which takes mana to use, or Rune Magic, which consumes a rune.<br> <br> Typical of most MMOs, Tibia features a variety of servers that focus on either PVP or PVE, where players can avoid combat against other players by adjusting a setting. CipSoft, the company behind Tibia, created a feature to help new players acclimate to the game through the use of Tutors. Tutors are players within Tibia who have displayed a willingness to help and are given the responsibility of monitoring the help chat channels to assist other players. CipSoft also works hard to make sure every vocation is balanced and releases new content every six months to expand the world. This adds more features to its already expansive list of Raids, Events, Guids, Unlimited Character Development and quests.<br> <br> On top of that, players are able to upgrade to a premium account which increases the features available. Premium members get access to premium-only zones, fully fleshed-out with their own quests. They also get access to a fast-travel system, an arena, new spells, extra stamina (to keep fighting longer), a loyalty system (which rewards you the longer you hold a premium account), reduced wait times to log-in on a full server, a market to sell loot, among other features. For a game that has been around for nearly twenty years, Tibia has it all and has stood the test of time. </p> <a class="collapsed" data-toggle="collapse" href="#collapseSummary" aria-expanded="false" aria-controls="collapseSummary"></a> </div> <hr> <div class="text-muted disclosure"> <p>Disclosure: FreeToGame works closely with publishers and developers to offer a free and rewarding experience. In order to keep everything free to use we may sometimes earn a small commission from some partners. Find more info in our <a href="faq.php">FAQ</a> page. </p> <p> </p> </div>  <h2 class="mt-5 h3">Additional Information</h2> <div class="text-muted mt-n2"> <i class="fas fa-info-circle mr-2"></i>Please note this free-to-play game may or may not offer optional in-game purchases.</div> <hr class="mt-2 mb-3"> <div class="row mb-3"> <div class="col-6 col-md-4"> <span class="text-muted">Title<br></span> <p>Tibia</p> </div> <div class="col-6 col-md-4"> <span class="text-muted">Developer<br></span> CipSoft </div> <div class="col-6 col-md-4"> <span class="text-muted">Publisher<br></span> CipSoft </div> <div class="col-6 col-md-4"> <span class="text-muted">Release Date<br></span> January 07, 1997 </div> <div class="col-6 col-md-4"> <span class="text-muted">Genre<br></span> MMORPG </div> <div class="col-6 col-md-4"> <span class="text-muted">Platform<br></span> <i class="fab fa-windows mr-1"></i> Windows (Client) </div> </div>  <h2 class="h3 font-weight-dark text-center text-lg-left mt-5 mb-0">Tibia Screenshots</h2> <hr class="mt-2 mb-3"> <div class="row text-center text-lg-left"> <div class="col-lg-4 col-md-4 col-6"> <a href="index.php" data-lity class="d-block mb-3 h-100" alt="Tibia Gameplay Screenshot 1"> <img class="thumb-gallery shadow-sm rounded" src="g/339/Tibia-Gameplay-1-small.jpg" alt="Tibia Thumbnail 1"> </a> </div> <div class="col-lg-4 col-md-4 col-6"> <a href="index.php" data-lity class="d-block mb-3 h-100" alt="Tibia Gameplay Screenshot 2"> <img class="thumb-gallery shadow-sm rounded" src="g/339/Tibia-Gameplay-2-small.jpg" alt="Tibia Thumbnail 2"> </a> </div> <div class="col-lg-4 col-md-4 col-6"> <a href="index.php" data-lity class="d-block mb-3 h-100" alt="Tibia Gameplay Screenshot 3"> <img class="thumb-gallery shadow-sm rounded" src="g/339/Tibia-Gameplay-3-small.jpg" alt="Tibia Thumbnail 3"> </a> </div> </div>  <h2 class="h3 font-weight-dark text-center text-lg-left mt-5 mb-0">Minimum System Requirements <span class="small text-muted">(Windows)</span> </h2> <hr class="mt-2 mb-3"> <div class="row"> <div class="col-sm-6"> <span class="text-muted">OS<br></span> <p>Windows XP or newer. Linux Compatible</p> <span class="text-muted">Memory<br></span> <p>128 MB</p> <span class="text-muted">Storage<br></span> <p>100 MB</p> </div> <div class="col-sm-6"> <span class="text-muted">Processor<br></span> <p>Any 500 MHz CPU or better</p> <span class="text-muted">Graphics<br></span> <p>Any GPU that supports at least DirectX 5.0</p> <span class="text-muted">Additional Notes<br></span> <p>Specifications may change during development</p> </div> </div>  <hr> <div class="text-muted small">All material on this page is copyrighted by ©CipSoft and their respective licensors. All other trademarks are the property of their respective owners.</div> <div class="row mt-2 align-items-center mb-5"> <div class="col text-muted justify-content-center">Play this game and post your review! </div> <div class="col-6"> <a class="btn btn-primary float-right" href="#submitReview" role="button">Submit Review</a> </div> </div>  <a href="like/tibia.php" class="btn btn-outline-secondary btn-sm float-right">See All<i class="ml-1 fas fa-chevron-right"></i></a> <h2 class="h3">Games like Tibia</h2> <hr class="mt-2 mb-3"> <div class="row text-center text-lg-left"> <div class="game-card col-md-4 col-md-4 mb-4 video-card" data-video-src="/g/22/videoplayback.webm"> <div class="card grow shadow"> <div class="image-wrappers"> <img class="img2 card-img-top" width="262" height="148" src="g/22/thumbnail.jpg" alt="Wild Terra Online - A medieval sandbox MMO designed with core players in mind. "> <div class="loader-wrapper"> <div class="spinner-grow ftg-blue" role="status"> <span class="sr-only">Loading...</span> </div> </div> </div> <video class="featuredvideo3widget" loop preload="none" muted></video> <div class="card-body"> <span class="badge badge-ftg py-1 px-1 mt-1 float-right">FREE</span> <a href="wild-terra-online.php" class="stretched-link no-underline"><h4 class="card-title text-truncate mb-n1">Wild Terra Online</h4></a> </div> </div> </div> <div class="game-card col-md-4 col-md-4 mb-4 video-card" data-video-src="/g/177/videoplayback.webm"> <div class="card grow shadow"> <div class="image-wrappers"> <img class="img2 card-img-top" width="262" height="148" src="g/177/thumbnail.jpg" alt="Dungeon Fighter Online - A free to play arcade-style side-scrolling action game mixed with RPG elements."> <div class="loader-wrapper"> <div class="spinner-grow ftg-blue" role="status"> <span class="sr-only">Loading...</span> </div> </div> </div> <video class="featuredvideo3widget" loop preload="none" muted></video> <div class="card-body"> <span class="badge badge-ftg py-1 px-1 mt-1 float-right">FREE</span> <a href="dungeon-fighter-online.php" class="stretched-link no-underline"><h4 class="card-title text-truncate mb-n1">Dungeon Fighter Online</h4></a> </div> </div> </div> <div class="game-card col-md-4 col-md-4 mb-4 video-card" data-video-src="/g/119/videoplayback.webm"> <div class="card grow shadow"> <div class="image-wrappers"> <img class="img2 card-img-top" width="262" height="148" src="g/119/thumbnail.jpg" alt="Fantasy Tales Online - A free-to-play, retro MMO featuring puzzles, a rich crafting system and Randomly generated dungeons! "> <div class="loader-wrapper"> <div class="spinner-grow ftg-blue" role="status"> <span class="sr-only">Loading...</span> </div> </div> </div> <video class="featuredvideo3widget" loop preload="none" muted></video> <div class="card-body"> <span class="badge badge-ftg py-1 px-1 mt-1 float-right">FREE</span> <a href="fantasy-tales-online.php" class="stretched-link no-underline"><h4 class="card-title text-truncate mb-n1">Fantasy Tales Online</h4></a> </div> </div> </div> </div> </div> </div> </div> </div> </main> </body> 
<!-- Mirrored from www.freetogame.com/tibia by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Mar 2024 08:38:50 GMT -->
